...
import 'package:mppl/screens/home/articles.dart';
import 'package:timeago/timeago.dart' as timeago;
import 'package:mppl/services/database.dart';
import 'package:provider/provider.dart';
import 'package:mppl/models/user.dart';
import 'package:mppl/screens/home/postArticle.dart';
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              var date = DateTime.fromMillisecondsSinceEpoch(
                                  feeds[i].data["timeStamp"]);
                              var formattedDate =
                                  DateFormat.yMMMMd().add_jm().format(date);
                              var timeStampNow =
                                  DateTime.now().millisecondsSinceEpoch;
                              var diff =
                                  timeStampNow - feeds[i].data["timeStamp"];
                              return Container(
                                  height: 100,
                                  child: Padding(
